...
>**Note** It is the responsibility of the `IQuickDocPresenter` to ensure the HTML is properly sanitised before display (see [RSRP-186295](http://youtrack.jetbrains.com/issue/RSRP-186295) for a great reason why!). Using the helper classes listed below can help with this, particularly `XmlDocPresenterUtil.EscapeHtmlString`
