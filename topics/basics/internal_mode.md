...
* **Show Themed Icons** provides a tool window to browse icons that are shipped with the SDK and to create new compiled icons from SVGs (see [](Platform__Icons.md))
